...
ROOT_URL = 'https://securelist.com/all/'
news_link = []
...
def get_news_link(url):
    ...
    if list_req.status_code == requests.codes.ok:
        ...
        news_link_source = soup.find_all('h3', 'entry-title close')
...
def get_news_article():
    for link in news_link:
        ...
        insert = "INSERT INTO securelist (post_date, title, content, url, new_event_news) VALUES (%s, %s, %s, %s, %s)"
