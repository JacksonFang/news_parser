...
ROOT_URL = 'https://www.welivesecurity.com/'
...
def get_news_link(url):
    ...
    if list_req.status_code == requests.codes.ok:
        ...
        news_link_source = soup.find_all('div', 'text-wrapper col-sm-9 col-xs-8 no-padding')
...
def get_news_article():
    for link in news_link:
        ...
        # article content
        content = ''
        raw = soup.find('div', "col-md-10 col-sm-10 col-xs-12 formatted")
        if not raw:
            continue
        ...
        insert = "INSERT INTO welivesecurity (post_date, title, content, url, new_event_news)" + "VALUES (%s, %s, %s, %s, %s)"
